...
INSERT INTO public.customer_comp VALUES ('1119ff33-6dd2-4c0a-b113-a90ee32a01ca', 'andi@user.com', 'Andi B.', 'TicketingSystem.customer.core.CustomerImpl', '081234222666', 'customer_impl');
INSERT INTO public.customer_comp VALUES ('1129ff33-6dd2-4c0a-b113-a90ee32a01ca', 'budi@user.com', 'Budi C.', 'TicketingSystem.customer.core.CustomerImpl', '081234222667', 'customer_impl');
INSERT INTO public.customer_comp VALUES ('1139ff33-6dd2-4c0a-b113-a90ee32a01ca', 'cahyo@user.com', 'Cahyo D.', 'TicketingSystem.customer.core.CustomerImpl', '081234222668', 'customer_impl');
INSERT INTO public.customer_comp VALUES ('1149ff33-6dd2-4c0a-b113-a90ee32a01ca', 'dewi@user.com', 'Dewi E.', 'TicketingSystem.customer.core.CustomerImpl', '081234222669', 'customer_impl');
INSERT INTO public.customer_comp VALUES ('1159ff33-6dd2-4c0a-b113-a90ee32a01ca', 'eka@user.com', 'Eka F.', 'TicketingSystem.customer.core.CustomerImpl', '081234222670', 'customer_impl');
INSERT INTO public.customer_comp VALUES ('1169ff33-6dd2-4c0a-b113-a90ee32a01ca', 'fajar@user.com', 'Fajar G.', 'TicketingSystem.customer.core.CustomerImpl', '081234222671', 'customer_impl');
...
ALTER TABLE ONLY public.customer_comp
    ADD CONSTRAINT customer_comp_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.customer_impl
    ADD CONSTRAINT customer_impl_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.customer_impl
    ADD CONSTRAINT fksunou9u52lv8ggdtok7v8poy2 FOREIGN KEY (id) REFERENCES public.customer_comp(id);
...
INSERT INTO public.address_comp VALUES ('89613755-6a6e-40d4-a79e-e6872d0628a4', 'Depok', 17149, 'Depok', false, 'TicketingSystem.customer.core.AddressComponent', 'Jawa Barat', 'Jalan Keadilan', '-', 45155, '1119ff33-6dd2-4c0a-b113-a90ee32a01ca', 'address_impl');
INSERT INTO public.address_comp VALUES ('5ccdb72b-4e11-4c01-a2e3-8ebd8ca54bbe', 'Depok', 25980, 'Beji', false, 'TicketingSystem.customer.core.AddressComponent', 'Jawa Barat', 'jalan test 1', 'Pondok Cina', 16424, '1119ff33-6dd2-4c0a-b113-a90ee32a01ca', 'address_impl');
INSERT INTO public.address_comp VALUES ('3b76a139-1177-4734-8e27-bd82b76fc731', 'Depok', 7106, 'Depok', true, 'TicketingSystem.customer.core.AddressComponent', 'Jawa Barat', 'Jalan Halo', '-', 0, '1119ff33-6dd2-4c0a-b113-a90ee32a01ca', 'address_impl');
...
ALTER TABLE ONLY public.address_comp
    ADD CONSTRAINT fkbgm280ynmjs48rujdwrfty6cy FOREIGN KEY (customer_id) REFERENCES public.customer_comp(id);
